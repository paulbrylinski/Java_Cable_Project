...
public class BrylinskiMainClass 
{
...

	{
				...
				displayOrderReport(planName, planCost, upgradeName, upgradeCost, paymentName, paymentFee, 
				paymentFeeAmount, orderTotal);
				...
				displayFinalReport(userName, planCountA, 
				planCountB, planCountC, upgradeCountA, upgradeCountB, 
				upgradeCountC, upgradeCountD, paymentTypeCountA, paymentTypeCountB, 
				paymentTypeCountC, totalCountSales, grandTotalSales);
				}
				...
				public static void displayOrderReport(String borrowedplanName, double borrowedPlanCost, 
				String borrowedUpgradeName, double borrowedUpgradeCost, String borrowedPaymentName,
				double borrowedPaymentFee, double borrowedPaymentFeeAmount, double borrowedOrderTotal)
				{//begin order report
				...
				//finalReport Menu
				public static void displayFinalReport(String borrowedUserName, int borrowedPlanCountA, 
				int borrowedPlanCountB, int borrowedPlanCountC, int borrowedUpgradeCountA, int borrowedUpgradeCountB, 
				int borrowedUpgradeCountC, int borrowedUpgradeCountD, int borrowedPaymentTypeCountA, 
				int borrowedPaymentTypeCountB, int borrowedPaymentTypeCountC, int borrowedTotalCountSales, 
				double borrowedGrandTotalSales) 
				{//begin final report
				...
				{//scanner declared, opening upgradeSelection	
				char localSelection = ' ';
				displayUpgradeMenu();
				localSelection = borrowedInput.next().toUpperCase().charAt(0);
